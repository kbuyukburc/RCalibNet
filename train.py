...
parser.add_argument('-s', '--seq', help="Sequence length", default=6, type=int)
parser.add_argument('-b', '--batch', help="Batch length", default=8, type=int)
...
for epoch in range(60):
    ...
    print(f'\n epch : {epoch} loss : {np.array(loss_list).mean()} {err_axis}', end='\n')
    torch.save(modelrnn.state_dict(), f"rcalib-{epoch}.ckpt")
